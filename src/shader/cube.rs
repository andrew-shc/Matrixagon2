...
// TODO: potential Vertex proc macro in the future (for fun)
#[derive(Copy, Clone, Debug)]
pub(crate) struct ExCubeVertex {
    pub(crate) pos: [f32; 3],
    pub(crate) uv: [f32; 2],
}
...
impl ExCubeVertex {
    fn get_binding_description() -> vk::VertexInputBindingDescription {
        vk::VertexInputBindingDescription {
            binding: 0,
            stride: mem::size_of::<ExCubeVertex>() as u32,
    ...
    fn get_attribute_description() -> Vec<vk::VertexInputAttributeDescription> {
        vec![
            vk::VertexInputAttributeDescription {
                ...
                offset: offset_of!(ExCubeVertex, pos) as u32,
            },
            vk::VertexInputAttributeDescription {
                binding: 0,
                location: 1,
                format: vk::Format::R32G32_SFLOAT,
                offset: offset_of!(ExCubeVertex, uv) as u32,
            },
        ]
    }
}
...
impl CubeRasterizer {
    pub(crate) unsafe fn new(device: Rc<Device>, extent: vk::Extent2D, color_format: vk::Format,
        ...
        let (shader_stages, shader_modules) = gen_shader_modules_info(
            device.clone(), vec![
                ("C:/Users/andrewshen/documents/matrixagon2/src/shader/cube.vert", vk::ShaderStageFlags::VERTEX),
                ("C:/Users/andrewshen/documents/matrixagon2/src/shader/cube.frag", vk::ShaderStageFlags::FRAGMENT),
            ]);

        let binding_descrp = ExCubeVertex::get_binding_description();
        let attr_descrp = ExCubeVertex::get_attribute_description();
...
impl Shader for CubeRasterizer {
    ...
    unsafe fn draw_command(&self, cmd_buf: vk::CommandBuffer, framebuffer: vk::Framebuffer) {
        ...
        self.device.cmd_bind_index_buffer(cmd_buf, self.terrain_ibo.unwrap().0, 0, vk::IndexType::UINT16);
