...
impl ChunkMeshUtil for ChunkGeneratorMF<'_> {
...
impl ChunkGeneratable for ChunkGeneratorMF<'_> {
    ...
    fn generate_mesh(&self, pos: Length3D, voxels: &[Self::P]) -> Vec<(Vec<Self::V>, Vec<Self::I>, RenderDataPurpose)> {
    ...
    fn aggregate_mesh(&self, chunks: &HashMap<Position<Self::B>, Chunk<Self::P, Self::V, Self::I, Self::B>>) -> Vec<(Vec<Self::V>, Vec<Self::I>, RenderDataPurpose)> {
